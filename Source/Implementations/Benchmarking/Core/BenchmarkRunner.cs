...
namespace Benchmarking.Core
{
    public static class BenchmarkRunner
    {
        ...
        public static BenchmarkData RunBenchmarkCategory(IBenchmarkCategory benchmarkCategory)
        {
        ...
        public static string RunBenchmarkCategoryToJson(IBenchmarkCategory benchmarkCategory) 
        {
